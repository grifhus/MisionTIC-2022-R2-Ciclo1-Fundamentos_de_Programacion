...
# **¿Cómo debo responder?**  
#Imprimir costo del producto sin descuento
preciocondescuento = 24
descuento1 = 15
preciosindescuento =  ((preciocondescuento*100)/(100-descuento1))
print ('El precio de los pantalones sin descuento es de ', preciosindescuento, 'euros')
